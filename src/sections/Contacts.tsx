                ...
                <div className="w-full flex flex-col items-start mt-8">
                    <div className="flex flex-col gap-6 w-full md:w-auto relative z-10">
                        ...
                        <button
                            ...
                            className="reveal-contact-item flex items-center gap-4 py-2 w-full md:w-[420px] text-left cursor-pointer focus:outline-none group"
                        >
                            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
                                <svg className="w-5 h-5 transition-transform group-hover:scale-105" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a
                            ...
                            className="reveal-contact-item flex items-center gap-4 py-2 w-full md:w-[420px]"
                        >
                            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
                        ...
                        <a
                            href="#"
                            className="reveal-contact-item cv-link flex items-center gap-4 py-2 w-full md:w-[420px]"
                        >
                            <div className="w-8 h-8 flex-shrink-0 flex items-center justify-center">
                                <span className="text-lg text-[#F7F7F7]">→</span>
                            </div>
                            <div className="flex flex-col">
